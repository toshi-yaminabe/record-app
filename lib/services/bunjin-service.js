...
import { DEFAULT_BUNJINS, BUNJIN_LIMITS } from '@/lib/constants.js'
...
export async function createBunjin(userId, data) {
  ...
  if (customCount >= BUNJIN_LIMITS.MAX_CUSTOM) {
    throw new ConflictError(`Maximum ${BUNJIN_LIMITS.MAX_CUSTOM} custom bunjins allowed`)
  }
