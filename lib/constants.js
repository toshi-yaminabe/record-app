...
// モックユーザーID（開発環境・テスト用、Flutter/seed.mjsと同期すること）
export const MOCK_USER_ID = 'mock-user-001'

// 分人数上限
export const BUNJIN_LIMITS = Object.freeze({
  MAX_TOTAL: 8,
  MAX_CUSTOM: 3,
  DEFAULT_COUNT: 5,
})
...
// Gemini APIタイムアウト (ms)
export const GEMINI_API_TIMEOUT_MS = 50000

// 音声ファイル制限
export const MAX_AUDIO_SIZE_BYTES = 6 * 1024 * 1024 // 6MB
